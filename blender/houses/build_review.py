...
- `{slug}.blend`: editable source, named meshes, trophy marker empties.
- `{slug}-visual.fbx`: static visual export, without review lights/camera/ground.
- `{slug}-visual.obj` and `.mtl`: alternate export and material colours.
- `{slug}-collision-mounts.rbxmx`: anchored invisible collision guides, Root,
...
```powershell
& 'C:/Program Files/Blender Foundation/Blender 5.2/blender.exe' -b -t 4 --python blender/houses/build_{'slime' if slug == 'slime' else 'treehouse'}.py
python blender/houses/package_assets.py {slug}
& 'C:/Program Files/Blender Foundation/Blender 5.2/blender.exe' -b -t 4 --python blender/houses/verify_assets.py -- {slug}
...
<nav aria-label="{escape(name)} files"><a href="{path}/{slug}.blend">Blender source</a><a href="{path}/{slug}-visual.obj">OBJ export</a><a href="{path}/{slug}-collision-mounts.rbxmx">Collision + mounts</a><a href="{path}/README.md">Import handoff</a></nav>
</article>''')
