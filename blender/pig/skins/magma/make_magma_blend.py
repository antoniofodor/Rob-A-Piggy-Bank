...
"""Build MAGMA as a node graph, in its own blend file.
    ...
    blender.exe --background --python skins/magma/make_magma_blend.py

Writes `skins/magma/magma.blend`. Then the ordinary loop:
...
# independent on purpose: a script in `make/` and a script in `skins/magma/`
