# Rainbow Tiger — legendary model revision 1
...
41 meshes, 44,326 triangles, largest mesh
7,152. All meshes are manifold; static FBX
round-trip bounds error is 0.000000954 studs. The idle
