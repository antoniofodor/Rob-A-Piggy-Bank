...
shapes=[
 ('RootPatch',[(105,40),(67,80),(74,177),(168,234)],
              [(105,40),(20,146),(116,247),(168,234)], .19,.140),
...
for name,left,right,layer,thickness in shapes:
    ...
    for j in range(1,rings):
        ...
        center=(a+b)*.5;half=(b-a)*.5*WIDTH_FULLNESS
...
(OUT/'study-report.json').write_text(json.dumps({'status':'Isolated geometry review; not installed on the game model','meshes':report,'triangles':sum(p['triangles'] for p in report)},indent=2))
