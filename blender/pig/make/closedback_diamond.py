...
"""Bake the DIAMOND skin's facet pack: colour overlay, normal and roughness.
    ...
    blender --background --python make/closedback_diamond.py
    (a redirected copy of assets/piggies/legendary/diamond/generate/make_diamond.py)
...
OUT = os.path.join(paths.RENDERS, "closed-back-test", "full", "diamond")   # CLOSED-BACK PASS: redirected, was paths.skin_dir(SKIN)
