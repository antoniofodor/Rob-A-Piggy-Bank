...
Source: `assets/houses/docs/HOUSE-TIER-BRIEF.md` revision 2, read September 16.
...
Toadstool prototype is now at `assets/houses/toadstool-cottage-v1/`, with FBX,
...
use `fishbowl-house-readable.png` for the clean presentation. All six images remain
...
legendary-motion.json for the nine-house specification, and portal-house-motion.html
