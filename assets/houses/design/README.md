...
`assets/houses/toadstool-cottage-v1/`; Studio integration remains pending.
...
| B3 / 4b.4 | Nine exterior concept sheets; dimensions/palettes/build route in `assets/houses/HANDOFF.md` | Fit exteriors to walk-in floorplans, final model geometry, measured part counts/bounds and pavement/mobile review |
...
`assets/houses/catalogue-design.json` is proposal data, not runtime configuration.
...
Rebuild prototype: `python assets/houses/design/build_preview.py`.
Rebuild gallery: `python assets/houses/design/build_gallery.py`.
Review script: `node assets/houses/design/review/render.cjs`
