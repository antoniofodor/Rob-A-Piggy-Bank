...
def build_outputs():
    ...
    root = root_xml()
    kit, kp = item(root, "Model", "CardboardFortInteriorKit")
    ...
    save_xml(root, "cardboard-fort-interior-kit.rbxmx")

    root = root_xml()
    demo, _ = item(root, "Model", "CardboardFortInterior_Review")
    ...
    save_xml(root, "cardboard-fort-interior-review.rbxmx")
