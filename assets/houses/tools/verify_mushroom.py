...
OUT=Path(__file__).resolve().parents[3]/'assets/houses/toadstool-cottage-v1'
bpy.ops.wm.open_mainfile(filepath=str(OUT/'toadstool-cottage.blend'))
...
bpy.ops.import_scene.fbx(filepath=str(OUT/'toadstool-cottage-visual.fbx'))
