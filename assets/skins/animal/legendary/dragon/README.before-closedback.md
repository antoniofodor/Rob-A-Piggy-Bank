...
An ember dragon built on the existing round piggy layout: 453
...
- `../../../../piggies/legendary/dragon/package/dragon-complete.blend`: editable scene in studs, packed maps, four-bone
  rig, review lighting, bone motion and animated material emission.
- `../../../../piggies/legendary/dragon/package/dragon-complete.fbx`: the main rigged model in its neutral pose.
- `../../../../piggies/legendary/dragon/package/dragon-idle.fbx`: matching four-second bone animation. Import onto the
  main model's rig, not as a second display model.
- `../../../../piggies/legendary/dragon/package/dragon-idle.gif`: actual model animation, 40 frames at 10 fps.
- `../../../../piggies/legendary/dragon/package/dragon_body_color.png` / `../../../../piggies/legendary/dragon/package/dragon_trim_color.png`: opaque 1024px green
  undercoat and warm seam maps. Trim covers Snout, Ears, Legs and Tail.
- `../../../../piggies/legendary/dragon/package/dragon_body_emissive.png` / `../../../../piggies/legendary/dragon/package/dragon_trim_emissive.png`: grayscale masks
...
- `../../../../piggies/legendary/dragon/package/DragonGlow.luau`: optional client material playback companion.
- `../../../../piggies/legendary/dragon/package/dragon-asset-report.json`, `../../../../piggies/legendary/dragon/package/animation-handoff.json`, `../../../../piggies/legendary/dragon/package/animation-checks.json`:
  exact colors, bones, timing, file hashes, geometry and export checks.
- Four model views, a scale close-up and `../../../../piggies/legendary/dragon/package/index.html` for review.
...
`../../../../piggies/legendary/dragon/package/DragonGlow.luau` as a ModuleScript and call
...
24 meshes / 40,426 triangles; largest mesh
8,130 triangles. All meshes are manifold.
