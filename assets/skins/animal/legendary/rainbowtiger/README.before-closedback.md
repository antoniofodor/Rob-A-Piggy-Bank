...
Built from the approved [option C concept](../../../../piggies/legendary/rainbowtiger/generate/rainbow-tiger-concept/concept-v5-c-swept-charcoal.png), with the latest adjustments:
...
- Two extra overlapping locks fill the inner cheek on each side and follow
  ...
  Root positions and attachment surfaces are verified in `../../../../piggies/legendary/rainbowtiger/package/beard-root-checks.json`.
...
[Model gallery](../../../../piggies/legendary/rainbowtiger/package/index.html) · [Actual animation](../../../../piggies/legendary/rainbowtiger/package/rainbowtiger-idle.gif) · [Ear close-up](../../../../piggies/legendary/rainbowtiger/package/rainbowtiger-ear-detail.png)

## Import files

**`../../../../piggies/legendary/rainbowtiger/package/rainbowtiger-complete.fbx` is the main model.** `../../../../piggies/legendary/rainbowtiger/package/rainbowtiger-idle.fbx`
contains its matching four-second bone animation. The editable source is
`../../../../piggies/legendary/rainbowtiger/package/rainbowtiger-complete.blend`; all review images show this actual model.
...
- `../../../../piggies/legendary/rainbowtiger/package/rainbowtiger-coat.png`: Body, with a dedicated seam-wrapped coat UV layout.
- `../../../../piggies/legendary/rainbowtiger/package/rainbowtiger-stripe-emission.png`: Body stripe-only glow mask, supplied separately
  for runtime setup; black pixels leave the coat dark.
- `../../../../piggies/legendary/rainbowtiger/package/rainbowtiger-charcoal-fur.png`: EarFur.
- `../../../../piggies/legendary/rainbowtiger/package/beard-flow-color.png`: CheekFur_-1, CheekFur_1, CheekFill_-1, CheekFill_1
  and BeardFur. These are the cheek layers, inner fills and under-snout locks.
- `../../../../piggies/legendary/rainbowtiger/package/beard-flow-normal.png`: the same beard meshes; assign as SurfaceAppearance
  NormalMap to retain the curved hair strokes. Keep the color map on ColorMap.
- `../../../../piggies/legendary/rainbowtiger/package/rainbowtiger-tail-gradient.png`: TailPlume.
...
Other parts use RGB colors recorded in `../../../../piggies/legendary/rainbowtiger/package/rainbowtiger-asset-report.json`.
...
brightness pulse through the Body material using `../../../../piggies/legendary/rainbowtiger/package/rainbowtiger-stripe-emission.png`
and the timing in `../../../../piggies/legendary/rainbowtiger/package/animation-handoff.json`. Only painted stripes emit; do not
