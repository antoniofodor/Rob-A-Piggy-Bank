...
"""Build PHOENIX as a node graph, in its own blend file.
    ...
    blender.exe --background --python assets/piggies/phoenix/generate/make_phoenix_blend.py
...
NOT. Measured off the mesh with `assets/piggies/legendary/phoenix/generate/measure.py`, the radius about
...
edge of every feather on the bird together. `assets/piggies/phoenix/generate/preview_anim.py`
...
# independent on purpose: a script in `make/` and a generator in `assets/piggies/phoenix/generate/`
...
FEATHERS = dict(
    ...
    # the quadratic's 2.19 / 0.87 / 2.22 / 3.16. `assets/piggies/legendary/phoenix/generate/measure.py`
