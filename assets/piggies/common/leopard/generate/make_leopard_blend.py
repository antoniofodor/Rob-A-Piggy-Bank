...
Writes `assets/piggies/common/leopard/source/leopard.blend`. Then the ordinary loop:
...
# independent on purpose: a script in `make/` and a generator in `assets/piggies/common/leopard/generate/`
