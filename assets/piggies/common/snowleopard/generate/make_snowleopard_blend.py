...
Writes `assets/piggies/common/snowleopard/source/snowleopard.blend`. Then the ordinary loop:
...
# `assets/piggies/common/snowleopard/generate/` are two and three levels down, and a hardcoded `..` is a
