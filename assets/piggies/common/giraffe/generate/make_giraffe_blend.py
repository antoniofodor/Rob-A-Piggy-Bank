...
"""Build the Giraffe's coat as a node graph, in its own blend file.
    ...
    blender.exe --background --python assets/piggies/common/giraffe/generate/make_giraffe_blend.py

Writes `assets/piggies/common/giraffe/source/giraffe.blend`. Then the ordinary loop:
...
# independent on purpose: a script in `make/` and a generator in `assets/piggies/common/giraffe/generate/`
