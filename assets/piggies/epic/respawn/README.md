...
Solid purple pig with a cyan/violet pixel coat, flank arrow, cyan eyes and seven small animated cubes rising near the rear. Emission pulse and pixel motes. New aura specification, not an installed runtime emitter.

Tier: **Epic**. 4 maps; 84 added accessory triangles.

- [Packed Blender review](package/respawn-arcade-v1.blend)
- [Procedural source](source/respawn-arcade-v1-procedural.blend)
- [Complete static FBX](package/respawn-arcade-v1-complete.fbx)
- [Front](preview/respawn-arcade-v1-hero.png), [rear](preview/respawn-arcade-v1-back.png), [concept](preview/respawn-arcade-v1-concept.png)
...
Rebuild: `blender -b --python assets/piggies/arcade-build-v1/build_arcade.py -- --skin respawn`.
