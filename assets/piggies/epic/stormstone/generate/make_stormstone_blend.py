...
"""Build STORM STONE as a node graph, in its own blend file.
    ...
    blender.exe --background --python assets/piggies/epic/stormstone/generate/make_stormstone_blend.py

Writes `assets/piggies/epic/stormstone/source/stormstone.blend`. Then the ordinary loop, plus the
alpha pass:
...
# independent on purpose: a script in `make/` and a generator in `assets/piggies/epic/stormstone/generate/`
