...
Chunky teal, navy and cream pixel camouflage, stepped clusters and sparse pixel diamonds, solid teal snout and cream feet. Fixed limited-color artwork, no glow, floating cubes or extra geometry.

Tier: **Rare**. 2 maps; 0 added accessory triangles.

- [Packed Blender review](package/pixel-arcade-v1.blend)
- [Procedural source](source/pixel-arcade-v1-procedural.blend)
- [Complete static FBX](package/pixel-arcade-v1-complete.fbx)
- [Front](preview/pixel-arcade-v1-hero.png), [rear](preview/pixel-arcade-v1-back.png), [concept](preview/pixel-arcade-v1-concept.png)
...
Rebuild: `blender -b --python assets/piggies/arcade-build-v1/build_arcade.py -- --skin pixel`.
