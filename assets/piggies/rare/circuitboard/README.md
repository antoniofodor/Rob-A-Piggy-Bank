# Circuit Board — Arcade v1

Forest-green printed circuit coat with gold right-angle traces, round solder pads and small dark chip rectangles. Dark green snout, muted brass feet and ear interiors. Entire circuit design is flat printed artwork; no glow or geometry.

Tier: **Rare**. 2 maps; 0 added accessory triangles.

- [Packed Blender review](package/circuitboard-arcade-v1.blend)
- [Procedural source](source/circuitboard-arcade-v1-procedural.blend)
- [Complete static FBX](package/circuitboard-arcade-v1-complete.fbx)
- [Front](preview/circuitboard-arcade-v1-hero.png), [rear](preview/circuitboard-arcade-v1-back.png), [concept](preview/circuitboard-arcade-v1-concept.png)
...
Rebuild: `blender -b --python assets/piggies/arcade-build-v1/build_arcade.py -- --skin circuitboard`.
