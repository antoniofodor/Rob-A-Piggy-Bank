# Player One — Arcade v1

16-bit red and cream pig with quantized pixel shading, dithered shadow transitions and a cream 1P emblem on both flanks. Original smooth 3D silhouette retained. Rare because the selected direction requires an authored coat.

Tier: **Rare**. 2 maps; 0 added accessory triangles.

- [Packed Blender review](package/playerone-arcade-v1.blend)
- [Procedural source](source/playerone-arcade-v1-procedural.blend)
- [Complete static FBX](package/playerone-arcade-v1-complete.fbx)
- [Front](preview/playerone-arcade-v1-hero.png), [rear](preview/playerone-arcade-v1-back.png), [concept](preview/playerone-arcade-v1-concept.png)
...
Rebuild: `blender -b --python assets/piggies/arcade-build-v1/build_arcade.py -- --skin playerone`.
