...
> re-briefed in `docs/HOUSE-TIER-BRIEF.md` revision 2 (toadstool, fairy
...
All 18 houses should use the same achievement/trophy records and display
capacity. Theme mappings cover cozy, classic, modern and royal variants;
a new style always has a tested fallback room. House value changes the look,
not achievement access or gameplay power.
